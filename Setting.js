...
global.mongodb = process.env.MONGODB_URI || "mongodb+srv://Pannelious:masterpeace@atlascluster.ykfgwfj.mongodb.net/?retryWrites=true&w=majority" ;            // PUT MONGODB KEY HERE, WITHOUT MONGODB YOUR BOT WILL NOT RUN
...
module.exports = {
  ...
  botname: process.env.BOT_NAME       || 'MASTERPEACE-ᴍᴅ',         // ADD YOUR BOT NAME
  ownername:  process.env.OWNER_NAME  || `MASTERPEACE`, // ADD YOUR NAME
  ...
  //==============================[WHAT'SAPP FEATURES]==============================
  author:  process.env.PACK_AUTHER  || 'MASTERPEACE',      // ADD YOUR STICKER AUTHOR NAME
  ...
  packname:  process.env.PACK_NAME  || "MASTERPEACE" ,          // ADD YOUR STICKER PACKNAME
